...
@interface LCFString : NSObject

/// aes加密
/// @param content 需要加密的内容
+ (NSString *)aesDecodeString:(NSString *)content;

/// aes解密
/// @param content 需要解密的内容
+ (NSString *)aesEncodeString:(NSString *)content;

+ (NSString *)jsonString:(id )dics;
