...
#import "LCPushNotificationConfiguration.h"
#import "LCPushMessage.h"

/**
 收到消息通知（数据是OPushMessage对象，可能是推送数据、自定义消息数据，APNs、本地通知等的回调）
 */
extern NSString *const LCPushDidReceiveMessageNotification;
 ...
 */
+ (void)setupNotification:(LCPushNotificationConfiguration *)configuration;
...
/**
 ...
 @param message 消息数据
 */
+ (void)addLocalNotification:(LCPushMessage *)message;
